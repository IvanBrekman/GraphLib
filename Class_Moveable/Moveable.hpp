...
class Moveable {
    public:
        ...
        Moveable& move_to_point(Vec2f point)      { return move_to_shift(point - m_mainPoint);            }
        
        Moveable& move_to_shift(double x, double y) { return move_to_shift(Vec2f(x, y));                  }
        Moveable& move_to_point(double x, double y) { return move_to_shift(Vec2f(x, y) - m_mainPoint);    }
        // =================================================
